...
public class AppProperties {
    private static final String SERVER_URL ="http://11.1.1.48"; //修改这个两个ip
    private static final String IP ="11.1.1.48";
    ...
    public static final String SERVER ="http://192.168.43.204:6028/";
    //    public static final String SERVER="http://82.156.138.114:6027/";
    public static final String SERVER_MEDIA_URL="http://192.168.43.204/files/media/";
    public static final String SERVER_RECORD_URL="http://192.168.43.204/files/record/";
