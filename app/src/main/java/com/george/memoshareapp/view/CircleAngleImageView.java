...
public class CircleAngleImageView extends AppCompatImageView {
    ...
    public CircleAngleImageView(Context context) {
        this(context, null);
        init(context, null);
    }
    public CircleAngleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context, attrs);
    }
    public CircleAngleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        maxHeight = array.getDimensionPixelOffset(R.styleable.RoundCornerImageView_item_max_height, 0);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (drawable != null && maxHeight > 0) {
            int drawableWidth = drawable.getIntrinsicWidth();
            int drawableHeight = drawable.getIntrinsicHeight();
            float scale = (float) drawableHeight / (float) drawableWidth;
