...
//        正式
        Glide.with(context).load(AppProperties.SERVER_MEDIA_URL + huodonglist.get(position).getFirstImagePath()).thumbnail(Glide.with(context).load(R.drawable.photo_loading)).into(imageView);//测试
