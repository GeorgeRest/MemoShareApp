...
import com.george.memoshareapp.activities.TestUserPublishActivity;
...
public class UserPublishRecyclerAdapter extends RecyclerView.Adapter<UserPublishRecyclerAdapter.ViewHolder> implements View.OnClickListener{
            ...
            switch (v.getId()) {
                case R.id.iv_user_publish_recorder:
                    if (holder.recordings.size() > 0) {
                        handleClick(holder.recordings.get(0).getRecordCachePath(), holder.iv_user_publish_recorder);
    ...
    private void handleClick(String recordPath, ImageView iv) {
        ...
        if (fragment == null) {
            ...
            if (fragment != bt_fragment) {
                ...
                FragmentTransaction fragmentTransaction = ((TestUserPublishActivity) this.context).getSupportFragmentManager().beginTransaction();
    ...
    public void resetFragment() {
        if (fragment != null) {
            fragment.stopPlayback();
            TestUserPublishActivity mContext = (TestUserPublishActivity) this.context;
